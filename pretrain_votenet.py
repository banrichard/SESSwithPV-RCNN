...
parser.add_argument('--labeled_ratio', type=float, default=0.1,
                    help='Percentage of labeled data for training [Options: 0.1, 0.3, 0.5, 0.7]')
parser.add_argument('--labeled_sample_list', default=None,
                    help='Labeled sample list from a certain percentage of training [static]')
parser.add_argument('--checkpoint_path', default=None, help='Model checkpoint path [default: None]')
parser.add_argument('--log_dir', default='./log_scannet/votenet',
...
DUMP_DIR = FLAGS.dump_dir if FLAGS.dump_dir is not None else LOG_DIR
...
if FLAGS.dataset == 'sunrgbd':
    ...
    TRAIN_DATASET = SunrgbdDetectionVotesDataset('train',
                                                 labeled_ratio=FLAGS.labeled_ratio,
                                                 labeled_sample_list=FLAGS.labeled_sample_list,
                                                 num_points=NUM_POINT, augment=True,
